...
class TransactionStatusTransactionData {
  final String title;
  ...
  TransactionStatusTransactionData({
    required this.title,
...
class TransactionStatusDialog extends StatelessWidget {
  final TransactionStatusTransactionData data;
                  ...
                  child: ClipPath(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.check_circle, size: fontSizeAmount + 60, color: Colors.green.shade500),
                          Text(
                            data.title,
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '\$ ${NumberFormat("#,##0.00").format(double.tryParse(data.amount) ?? 0)}',
                                  style: TextStyle(
                            ...
                            children: [
                              Expanded(
                                child: ElevatedButton.icon(
                                  ...
                                  label: const Text("OKAY", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
  ...
  Widget _transactionDetail1(BuildContext context, String title, String value, double fontSize) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 6),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
