...
class TransactionStatusCheckData {
  final String title;
...
class TransactionStatusCheckDialog extends StatelessWidget {
  ...
  const TransactionStatusCheckDialog({
    super.key,
    required this.data,
  ...
  Widget build(BuildContext context) {
    ...
    final double fontSizeDetail = isLandscape ? 14 : 12;
                  ...
                  child: ClipPath(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          // RepaintBoundary now wraps the full ticket
                          RepaintBoundary(
                            key: repaintKey,
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(20),
                              child: ClipPath(
                                ...
                                child: Container(
                                  ...
                                  padding: const EdgeInsets.all(20), // ✅ this padding now gets included
                                  child: Column(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      Icon(Icons.check_circle,
                                          size: fontSizeAmount + 40,
                                      ...
                                      if(data.sourceName.isNotEmpty)
                                      _transactionDetail(context, "Source alias", data.sourceName, fontSizeDetail),
                                      if(data.recipient.isNotEmpty)
                                      _transactionDetail(context, "Recipient alias", data.recipient, fontSizeDetail),
                                      if(data.transactionCode.isNotEmpty)
                                      _transactionDetail(context, "Transaction Code", data.transactionCode, fontSizeDetail),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '\$ ${NumberFormat("#,##0.00").format(double.parse(data.amount))}',
                                              style: TextStyle(
