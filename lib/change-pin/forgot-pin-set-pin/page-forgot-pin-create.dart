import 'package:bushra_mobile/change-pin/forgot-pin-set-pin/page-forgot-pin-confirm.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class ForgotPinPinInputScreen1 extends StatefulWidget {
  const ForgotPinPinInputScreen1({super.key});

  @override
  State<ForgotPinPinInputScreen1> createState() => _ForgotPinPinInputScreen1State();
}

class _ForgotPinPinInputScreen1State extends State<ForgotPinPinInputScreen1> {
  ...
  void onOkPressed() {
    ...
    if (enteredPin.length == 6) {
      //TODO
      Navigator.push(context, MaterialPageRoute(builder: (context) => ForgotPinPinInputScreen2(customerPin: enteredPin,)));
    } else {
