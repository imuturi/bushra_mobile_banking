import 'package:bushra_mobile/change-pin/forgot-pin-set-pin/page-forgot-pin-security-qsn.dart';
...
class ForgotPinAccountVerifyScreen extends StatefulWidget {
  const ForgotPinAccountVerifyScreen({super.key});
  @override
  State<ForgotPinAccountVerifyScreen> createState() => _ForgotPinAccountVerifyScreenState();
}

class _ForgotPinAccountVerifyScreenState extends State<ForgotPinAccountVerifyScreen> {
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const ForgotPinSecurityQuestions(),
                      ),
                    );
                  },
                  child: const Text(
