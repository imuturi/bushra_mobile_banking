...
class PayBillInternetBillScreen extends StatefulWidget {
  const PayBillInternetBillScreen({super.key});

  @override
  State<PayBillInternetBillScreen> createState() => _PayBillInternetBillScreenState();

}

class _PayBillInternetBillScreenState extends State<PayBillInternetBillScreen> {
  ...
  void initState(){
    super.initState();
    futureBillers = fetchBillers("INTERNET");
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Select internet provider company", style: TextStyle(color: Colors.grey)),
            const SizedBox(height: 8),
            _buildBillersDropDown(),

            const SizedBox(height: 10),
            const Text("Enter your registered Internet ID", style: TextStyle(color: Colors.grey)),
            _buildTextInputFieldGray('Eg 12345677', billCommonField, TextInputType.text),
                ...
                onPressed: () async{
                  ...
                  showDialog(
                    ...
                    builder: (context) => ConfirmTransferDialog(
                      dialogDescription: "Please confirm you are making internet bill payment",
                      ...
                      onConfirm: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>  PinInputCommitBillPaymentTransactionScreen(
                          ...
                          transactionNarration: narration.isEmpty ? 'Internet Bill Payment' : narration,
                          billerId: billerId,
