...
class PayBillElectricityScreen extends StatefulWidget {
  const PayBillElectricityScreen({super.key});

  @override
  State<PayBillElectricityScreen> createState() => _PayBillElectricityScreenState();

}

class _PayBillElectricityScreenState extends State<PayBillElectricityScreen> {
  ...
  void initState(){
    super.initState();
    futureBillers = fetchBillers("ELECTRICITY");
  ...
  List<int> selectedDays = [1, 6]; // M and S
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Select electricity company", style: TextStyle(color: Colors.grey)),
            //const SizedBox(height: 2),
              ...
              child: ElevatedButton(
                onPressed: () async{
                  ...
                  if(debitAccountNumber.isEmpty || debitAccountNumber.length<10){
                    ...
                    showSnackBar(context, 'Invalid Amount Selected', Colors.red);
                    return;
                  }
                  ...
                  showDialog(
                    ...
                    builder: (context) => ConfirmTransferDialog(
                      dialogDescription: "Please confirm you are making an electricity bill payment",
                      ...
                      onConfirm: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>  PinInputCommitBillPaymentTransactionScreen(
                          ...
                          transactionNarration: narration.isEmpty ? 'Electricity Bill Payment' : narration,
                          billerId: billerId,
