...
class PayBillWaterBillScreen extends StatefulWidget {
  const PayBillWaterBillScreen({super.key});
  @override
  State<PayBillWaterBillScreen> createState() => _PayBillWaterBillScreenState();
}

class _PayBillWaterBillScreenState extends State<PayBillWaterBillScreen> {
  ...
  void initState(){
    super.initState();
    futureBillers = fetchBillers("WATER");
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Select your water provider company", style: TextStyle(color: Colors.grey)),
                ...
                onPressed: () async{
                  ...
                  showDialog(
                    ...
                    builder: (context) => ConfirmTransferDialog(
                      dialogDescription: "Please confirm you are making a water bill payment",
                      ...
                      onConfirm: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>  PinInputCommitBillPaymentTransactionScreen(
                          ...
                          transactionNarration: narration.isEmpty ? 'Water Bill Payment' : narration,
                          billerId: billerId,
