...
class PayBillTvBillScreen extends StatefulWidget {
  const PayBillTvBillScreen({super.key});

  @override
  State<PayBillTvBillScreen> createState() => _PayBillTvBillScreenState();

}

class _PayBillTvBillScreenState extends State<PayBillTvBillScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Select TV you use", style: TextStyle(color: Colors.grey)),
            const SizedBox(height: 8),
            _buildBillersDropDown(),

            const SizedBox(height: 10),
            const Text("Enter your receiver number for your TV", style: TextStyle(color: Colors.grey)),
            _buildTextInputFieldGray('Eg 22244333', billCommonField, TextInputType.text),
                ...
                onPressed: () async{
                  ...
                  showDialog(
                    ...
                    builder: (context) => ConfirmTransferDialog(
                      dialogDescription: "Please confirm you are making a TV bill payment",
                      ...
                      onConfirm: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>  PinInputCommitBillPaymentTransactionScreen(
                          ...
                          transactionNarration: narration.isEmpty ? 'TV Bill Payment' : narration,
                          billerId: billerId,
